...
@Component({
  ...
  template: ` <div
    class="flex-1 h-full flex flex-col space-y-5 justify-center items-center mx-auto w-[600px]"
  >
    <div class="w-full">
    ...
    <div>
      <select #maker (change)="changeSelectedMaker(maker.value)" name="make" class="w-52">
    ...
    <div>
      <select #model name="model" class="w-52">
    ...
    <input required type="number" min="2012" max="2023" value="2016" class="block w-52" />
    <input type="text" class="w-52" />
    <div class="w-full">
    ...
    <div *ngIf="carTypes.length !== 0" class="flex space-x-5">
      <div
        *ngFor="let carType of carTypes; let i = index"
        ...
        [ngClass]="{
          'outline outline-2 bg-stone-200 transition-none': carType.name === selectedCar?.name
        }"
...
export default class Index {
  ...
  carImages = [
    'https://i.pinimg.com/originals/79/81/2b/79812b8dcc2b5e0c4f6e573fc3797107.png',
