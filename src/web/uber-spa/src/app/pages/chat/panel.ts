...
@Component({
  ...
  template: `<div class="w-80 flex-1 flex flex-col border-r-[1px] h-full">
    <div class="h-32 p-6">
      <div class="text-2xl">Conversations</div>
      <p class="text-gray-500 text-sm">Help out the customers with their problems</p>
    </div>
