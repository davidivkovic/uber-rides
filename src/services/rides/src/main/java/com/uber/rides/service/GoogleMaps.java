...
public class GoogleMaps {
    ...
    public static class APIClient {
        ...
        public DirectionsResult sendRequest(DirectionsApiRequest request) {
    ...
    public DirectionsResult getDirections(
        ...
        return client.sendRequest(directionsRequest);
    }
    ...
    public DirectionsRoute getDirections(Route route) {
        ...
        var response = client.sendRequest(directionsRequest);
        return response == null ? null : response.routes[0];
    }
